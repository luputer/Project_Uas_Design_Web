            ...
            <main class="container mx-auto px-4 py-8 w-full">
                ...
                <section id="fasilitas" class="py-16 bg-white dark:bg-gray-800 rounded-lg shadow-sm w-full mx-auto p-5">
                    ...
                    <div class="join join-vertical mx-auto w-full">
                        <div
                            class="collapse collapse-arrow join-item border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-700">
        ...
        <div class="hero min-h-[70vh] bg-base-200">
            <div class="hero-content flex-col lg:flex-row-reverse gap-8">
                <div class="flex-1 grid grid-cols-2 gap-4 max-w-xl">
                    <img src="https://placehold.co/600x400/png" class="rounded-lg shadow-2xl"
                ...
                <div class="flex-1">
                    <h1 class="text-5xl font-bold">Welcome to Your Dashboard!</h1>
                    <p class="py-6">Experience the power of modern analytics and project management in one place. Start
                        managing your projects more efficiently today.</p>
                    <button class="btn btn-primary">Get Started</button>
                </div>
            </div>
        </div>
            ...
            <div class="mb-8">
                ...
                <div class="join join-vertical w-full" x-data="{ activeAccordion: 1 }">
                    <div class="collapse collapse-arrow join-item border border-base-300">
                        <input type="radio" name="accordion-1" checked @click="activeAccordion = 1"
                            :checked="activeAccordion === 1" />
                        <div class="collapse-title text-xl font-medium">
                            How do I get started?
                        </div>
                        <div class="collapse-content">
                            <p>Getting started is easy! Simply click the "Get Started" button above and follow the
                                guided tutorial.</p>
                        </div>
                    </div>
                    <div class="collapse collapse-arrow join-item border border-base-300">
                        <input type="radio" name="accordion-1" @click="activeAccordion = 2"
                            :checked="activeAccordion === 2" />
                        <div class="collapse-title text-xl font-medium">
                            What features are included?
                        </div>
                        <div class="collapse-content">
                            <p>Our platform includes project management, team collaboration, task tracking, and detailed
                                analytics.</p>
                        </div>
                    </div>
                    <div class="collapse collapse-arrow join-item border border-base-300">
                        <input type="radio" name="accordion-1" @click="activeAccordion = 3"
                            :checked="activeAccordion === 3" />
                        <div class="collapse-title text-xl font-medium">
                            How can I contact support?
                        </div>
                        <div class="collapse-content">
                            <p>Our support team is available 24/7 through chat, email, or phone. Click the support icon
                    ...
                    <div id="slide1" class="carousel-item relative w-full" :class="{ 'hidden': activeSlide !== 1 }">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                            <div class="text-white text-center">
                                ...
                                <p class="py-6">Revolutionary mobile app development project with cutting-edge features.
                                </p>
                            </div>
                        </div>
